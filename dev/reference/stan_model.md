...
#>   18 : namespace model236f7d0a2cdb__namespace {
...
#>   27 : class model236f7d0a2cdb_ final : public model_base_crtp<model236f7d0a2cdb_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model236f7d0a2cdb_() {}
#>   32 :   model236f7d0a2cdb_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model236f7d0a2cdb__namespace::model236f7d0a2cdb_";
...
#>   62 :     return "model236f7d0a2cdb_";
#>   63 :   }
#>   64 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   65 :     return std::vector<std::string>{"stanc_version = stanc3 v2.38.0-11-g1deff3e",
#>   66 :              "stancflags = --"};
#>   67 :   }
#>   68 :   // Base log prob
...
#>   88 :       "model236f7d0a2cdb__namespace::log_prob";
...
#>  125 :       "model236f7d0a2cdb__namespace::log_prob";
...
#>  173 :       "model236f7d0a2cdb__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model236f7d0a2cdb__namespace::model236f7d0a2cdb_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model236f7d0a2cdb__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model236f7d0a2cdb__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model236f7d0a2cdb_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file236f66568e95( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file236f66568e95() {
